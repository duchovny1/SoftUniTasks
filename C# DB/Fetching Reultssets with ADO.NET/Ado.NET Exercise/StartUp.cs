...
{
    class InitialSetupAndVillianNames
    {
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                string queryToExecute = @"CREATE TABLE Countries (Id INT PRIMARY KEY IDENTITY,Name VARCHAR(50))
                ...
                queryToExecute = @"INSERT INTO Countries ([Name]) VALUES ('Bulgaria'),('England'),('Cyprus'),('Germany'),('Norway')
